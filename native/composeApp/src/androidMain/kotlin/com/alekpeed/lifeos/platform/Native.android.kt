...
actual object Native {
    ...
    // Firebase Messaging supplies the installation token registered by PushRegistration.
    actual fun devicePushToken(onToken: (String?) -> Unit) {
        com.google.firebase.messaging.FirebaseMessaging.getInstance().token
            .addOnSuccessListener { onToken(it) }.addOnFailureListener { onToken(null) }
    }
