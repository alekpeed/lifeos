...
### History
Trash and an activity log. Every save is diffed against the one it replaced, so a
deleted record waits 30 days before it is really gone and a recent edit can be put back
field by field.
