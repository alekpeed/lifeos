...
const ICONS = {
  ...
  ask: svg('<circle cx="8.8" cy="8.8" r="5"/><line x1="12.6" y1="12.6" x2="17" y2="17"/><path d="M7 7.6a1.8 1.8 0 1 1 2.4 1.7c-.5.2-.8.5-.8 1v.3"/><circle cx="8.6" cy="11.6" r="0.5" fill="currentColor" stroke="none"/>'),
  briefing: svg('<rect x="4.5" y="3" width="11" height="14" rx="1.3"/><rect x="7.5" y="1.8" width="5" height="2.4" rx="0.6"/><polyline points="6.8,8 8,9.2 9.6,7.2"/><line x1="11" y1="8.2" x2="13.5" y2="8.2"/><polyline points="6.8,12 8,13.2 9.6,11.2"/><line x1="11" y1="12.2" x2="13.5" y2="12.2"/>'),
  notifications: svg('<path d="M10 3.3a4.3 4.3 0 0 0-4.3 4.3v2.9L4 13.3h12l-1.7-2.8V7.6A4.3 4.3 0 0 0 10 3.3z"/><path d="M8.3 15.5a1.7 1.7 0 0 0 3.4 0"/>'),
